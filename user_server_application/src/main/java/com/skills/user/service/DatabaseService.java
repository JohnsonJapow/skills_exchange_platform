...
import com.skills.user.database.CachedConnection;
...
public class DatabaseService {
    ...
    //         if (conn == null) {
    //             throw new SQLException("Unable to connect to the user database.");
    //         }

    //         JsonArray responseJson = conn.executeQuery("select * from skill_exchange_user where username = ? and deleted != 'Y'",
    ...
    //         int rowsUpdated = conn.executeUpdate("update skill_exchange_user set password = ?, changePassword = 'N' where username = ?",
    ...
    //         int rowsUpdated = conn.executeUpdate("update skill_exchange_user set last_login = ? where username = ?",
